...
struct linSysType {
    ...
    void resetA();
    void buildA(const meshType& Mesh, const surfaceScalarField& flux, const volScalarField& C, const Time& runTime);
    void buildRHS( const meshType& Mesh, const volScalarField& C, const Time& runTime);
    void factorize();
