...
void linSysType::buildA(const meshType& Mesh, const surfaceScalarField& flux, const volScalarField& C, const simTime& runTime) {
    double dx = Mesh.dx;
    double dy = Mesh.dy;
    int row ;
    double a,b,g;
...
void linSysType::buildRHS( const meshType& Mesh, const volScalarField& C, const simTime& runTime ){
    double a,b,g;
    double t = runTime.time;
    t=t;
